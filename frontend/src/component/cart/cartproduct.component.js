                         ...
                         <div className='cart-container'>
                             <div className='cart-product'>
                                 <div>
                                     ...
                                     <div className="cart-product-capacity">
                                      {product.attributes.filter(a => a.name == 'Capacity').map(a =>
                                      <p className="product-attributes">{a.name}</p>
                                      )}
                                      {product.attributes.filter(a => a.id === 'Capacity').map(a => (a.items.map(i => (
                                      <button className=" attributes-button attributes-capacity" id="capacity">{i.value}</button>
                                      ))))}
                                      </div>
                                 </div>
